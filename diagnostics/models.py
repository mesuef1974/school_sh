...
class AcademicYear(models.Model):
    ...
    def __str__(self): return self.name
    class Meta: verbose_name = "سنة دراسية"; verbose_name_plural = "السنوات الدراسية"; ordering = ['-name']
...
class StrategicGoal(models.Model):
    ...
    def __str__(self): return self.title
    class Meta: verbose_name = "هدف استراتيجي"; verbose_name_plural = "الأهداف الاستراتيجية"
...
class OperationalGoal(models.Model):
    ...
    def __str__(self): return self.title
    class Meta: verbose_name = "هدف تشغيلي / مؤشر"; verbose_name_plural = "الأهداف التشغيلية / المؤشرات"
...
class EvidenceDocument(models.Model):
    ...
    def __str__(self): return self.title
    class Meta: verbose_name = "وثيقة دليل"; verbose_name_plural = "مستودع الأدلة"
...
class GroupExtension(models.Model):
    ...
    def __str__(self): return f"Extension for {self.group.name}"